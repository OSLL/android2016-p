...
public class NumActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!getIntent().getBooleanExtra("two", false)) {
            ...
            tvView = (TextView) findViewById(R.id.textView10);
            //tvView2 = (TextView) findViewById(R.id.textView);
            if (AppActivity.score1 > AppActivity.score2) {
                tvView.setText("Победа за тобой, "+AppActivity.name1String+"!");
                //tvView2.setText(AppActivity.score1);
            }
            if (AppActivity.score2 > AppActivity.score1) {
                tvView.setText("Победа за тобой, "+AppActivity.name2String+"!");
                //tvView2.setText(AppActivity.score2);
            }
            if (AppActivity.score1 == AppActivity.score2) {
                tvView.setText("Ничья!");
                //tvView2.setText(AppActivity.score1);
            }
        }
    }
